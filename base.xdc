...
#set_property PACKAGE_PIN K4 [get_ports {clk}];  #Bank 65, FPGA_CLK125_N
#set_property IOSTANDARD LVDS [get_ports {clk}]
#set_property PACKAGE_PIN K3 [get_ports {FPGA_CLK125_P}];  #Bank 65, FPGA_CLK125_P
...
set_property PACKAGE_PIN AD5 [get_ports {clk}]; #Bank 64, FPGA_USER_CLOCK_P
...
#set_property PACKAGE_PIN AA12 [get_ports {reset}]; #Bank 44, SW0
#set_property IOSTANDARD LVCMOS12 [get_ports {reset}];
set_property PACKAGE_PIN Y12 [get_ports {enable}]; #Bank 44, SW1
set_property IOSTANDARD LVCMOS12 [get_ports {enable}];
#set_property PACKAGE_PIN W11 [get_ports {Switch[2]}]; #Bank 44, SW2
#set_property IOSTANDARD LVCMOS12 [get_ports {Switch[2]}];
#set_property PACKAGE_PIN W12 [get_ports {Switch[3]}]; #Bank 44, SW3
#set_property IOSTANDARD LVCMOS12 [get_ports {Switch[3]}];
## push_button_4bits_tri_i
set_property PACKAGE_PIN AH14 [get_ports {start}]; #Bank 44, BTN0
...
## led_4bits_tri_o
set_property PACKAGE_PIN B5 [get_ports {LED[0]}]; #Bank 66, LED0
set_property PACKAGE_PIN A6 [get_ports {LED[1]}]; #Bank 66, LED1
set_property PACKAGE_PIN B8 [get_ports {LED[2]}]; #Bank 66, LED2
set_property PACKAGE_PIN A7 [get_ports {LED[3]}]; #Bank 66, LED3
...
## rgbled0_tri_o
set_property PACKAGE_PIN A9 [get_ports {done}];  #Bank 66, LED_B0
